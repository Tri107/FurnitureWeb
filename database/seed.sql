...
-- 12. Reviews (100)
INSERT INTO reviews (rating, review_comment, product_id, account_id, order_id) VALUES
    (5, 'Mong shop có thêm nhiều mẫu mã mới.', 1, 19, 8),
    (3, 'Gỗ chắc chắn, màu vân gỗ sang trọng.', 1, 11, 7),
    (5, 'Tuyệt vời, sẽ ủng hộ shop lần sau.', 1, 17, 53),
    (4, 'Sản phẩm chất lượng cao, giá cả phải chăng.', 1, 4, 7),
    (4, 'Sản phẩm chất lượng cao, giá cả phải chăng.', 1, 9, 16),
    (5, 'Gỗ chắc chắn, màu vân gỗ sang trọng.', 1, 15, 66),
    (3, 'Nhân viên giao nhận nhiệt tình, chu đáo.', 1, 14, 40),
    (4, 'Rất hài lòng về chất lượng và mẫu mã.', 1, 24, 29),
    (4, 'Thiết kế hiện đại, phù hợp với phòng khách.', 1, 13, 11),
    (5, 'Đóng gói rất kỹ, không trầy xước.', 1, 2, 17),
    (3, 'Vượt xa mong đợi của mình, đóng gói cẩn thận.', 2, 7, 64),
    (4, 'Sản phẩm chất lượng cao, giá cả phải chăng.', 2, 5, 15),
    (5, 'Vượt xa mong đợi của mình, đóng gói cẩn thận.', 2, 9, 67),
    (4, 'Phù hợp với không gian căn hộ nhỏ.', 2, 6, 33),
    (5, 'Tuyệt vời, sẽ ủng hộ shop lần sau.', 2, 14, 2),
    (5, 'Dễ dàng vệ sinh, sử dụng tiện lợi.', 2, 11, 22),
    (4, 'Dễ dàng vệ sinh, sử dụng tiện lợi.', 2, 24, 26),
    (4, 'Hài lòng với dịch vụ của shop.', 2, 23, 56),
    (4, 'Hơi khó lắp ráp một chút nhưng dùng rất thích.', 2, 10, 71),
    (5, 'Sản phẩm rất đẹp, đúng như mô tả.', 2, 13, 71),
    (5, 'Vượt xa mong đợi của mình, đóng gói cẩn thận.', 3, 16, 58),
    (4, 'Thiết kế hiện đại, phù hợp với phòng khách.', 3, 8, 50),
    (5, 'Dùng một thời gian thấy rất bền.', 3, 6, 17),
    (5, 'Đóng gói rất kỹ, không trầy xước.', 3, 4, 5),
    (5, 'Chất lượng gỗ khá tốt, giao hàng nhanh.', 3, 13, 9),
    (4, 'Mong shop có thêm nhiều mẫu mã mới.', 3, 21, 72),
    (5, 'Màu sắc không giống ảnh lắm nhưng vẫn ổn.', 3, 9, 48),
    (5, 'Đóng gói rất kỹ, không trầy xước.', 3, 12, 54),
    (4, 'Vượt xa mong đợi của mình, đóng gói cẩn thận.', 3, 19, 28),
    (5, 'Vượt xa mong đợi của mình, đóng gói cẩn thận.', 3, 3, 64),
    (5, 'Vượt xa mong đợi của mình, đóng gói cẩn thận.', 4, 18, 2),
    (5, 'Dễ dàng vệ sinh, sử dụng tiện lợi.', 4, 15, 57),
    (4, 'Màu sắc không giống ảnh lắm nhưng vẫn ổn.', 4, 17, 12),
    (4, 'Hài lòng với dịch vụ của shop.', 4, 5, 6),
    (4, 'Mong shop có thêm nhiều mẫu mã mới.', 4, 16, 18),
    (5, 'Tuyệt vời, sẽ ủng hộ shop lần sau.', 4, 9, 50),
    (5, 'Rất hài lòng về chất lượng và mẫu mã.', 4, 19, 28),
    (5, 'Gỗ chắc chắn, màu vân gỗ sang trọng.', 4, 13, 34),
    (5, 'Vượt xa mong đợi của mình, đóng gói cẩn thận.', 4, 23, 66),
    (4, 'Dễ dàng vệ sinh, sử dụng tiện lợi.', 4, 22, 68),
    (5, 'Phù hợp với không gian căn hộ nhỏ.', 5, 23, 38),
    (4, 'Giao hàng hơi chậm nhưng sản phẩm bù lại rất tốt.', 5, 5, 20),
    (4, 'Rất hài lòng về chất lượng và mẫu mã.', 5, 6, 24),
    (5, 'Gỗ chắc chắn, màu vân gỗ sang trọng.', 5, 3, 45),
    (5, 'Mong shop có thêm nhiều mẫu mã mới.', 5, 14, 73),
    (3, 'Nhân viên giao nhận nhiệt tình, chu đáo.', 5, 17, 52),
    (5, 'Dùng một thời gian thấy rất bền.', 5, 20, 31),
    (4, 'Tuyệt vời, sẽ ủng hộ shop lần sau.', 5, 19, 59),
    (5, 'Tuyệt vời, sẽ ủng hộ shop lần sau.', 5, 10, 7),
    (5, 'Tuyệt vời, sẽ ủng hộ shop lần sau.', 5, 16, 79),
    (5, 'Giá hơi cao nhưng chất lượng xứng đáng.', 6, 13, 33),
    (5, 'Giao hàng hơi chậm nhưng sản phẩm bù lại rất tốt.', 6, 2, 69),
    (5, 'Nhân viên giao nhận nhiệt tình, chu đáo.', 6, 15, 12),
    (3, 'Chất lượng gỗ khá tốt, giao hàng nhanh.', 6, 20, 16),
    (4, 'Giao hàng hơi chậm nhưng sản phẩm bù lại rất tốt.', 6, 23, 5),
    (3, 'Rất hài lòng về chất lượng và mẫu mã.', 6, 3, 25),
    (4, 'Sản phẩm chất lượng cao, giá cả phải chăng.', 6, 4, 20),
    (5, 'Hơi khó lắp ráp một chút nhưng dùng rất thích.', 6, 7, 64),
    (4, 'Tuyệt vời, sẽ ủng hộ shop lần sau.', 6, 19, 41),
    (5, 'Vượt xa mong đợi của mình, đóng gói cẩn thận.', 6, 24, 14),
    (5, 'Màu sắc không giống ảnh lắm nhưng vẫn ổn.', 7, 2, 20),
    (5, 'Vượt xa mong đợi của mình, đóng gói cẩn thận.', 7, 16, 15),
    (5, 'Thiết kế hiện đại, phù hợp với phòng khách.', 7, 4, 35),
    (5, 'Thiết kế hiện đại, phù hợp với phòng khách.', 7, 10, 16),
    (5, 'Sản phẩm chất lượng cao, giá cả phải chăng.', 7, 17, 37),
    (5, 'Tuyệt vời, sẽ ủng hộ shop lần sau.', 7, 22, 31),
    (5, 'Dễ dàng vệ sinh, sử dụng tiện lợi.', 7, 19, 32),
    (5, 'Nhân viên giao nhận nhiệt tình, chu đáo.', 7, 24, 25),
    (5, 'Thiết kế hiện đại, phù hợp với phòng khách.', 7, 3, 79),
    (5, 'Nhân viên giao nhận nhiệt tình, chu đáo.', 7, 8, 63),
    (4, 'Giá hơi cao nhưng chất lượng xứng đáng.', 8, 22, 10),
    (4, 'Giao hàng hơi chậm nhưng sản phẩm bù lại rất tốt.', 8, 15, 7),
    (5, 'Phù hợp với không gian căn hộ nhỏ.', 8, 19, 1),
    (5, 'Rất hài lòng về chất lượng và mẫu mã.', 8, 16, 7),
    (3, 'Đóng gói rất kỹ, không trầy xước.', 8, 17, 33),
    (4, 'Gỗ chắc chắn, màu vân gỗ sang trọng.', 8, 3, 12),
    (5, 'Rất êm và thoải mái, thiết kế đẹp.', 8, 21, 9),
    (5, 'Sản phẩm rất đẹp, đúng như mô tả.', 8, 13, 18),
    (5, 'Hài lòng với dịch vụ của shop.', 8, 24, 64),
    (3, 'Màu sắc không giống ảnh lắm nhưng vẫn ổn.', 8, 11, 10),
    (4, 'Màu sắc không giống ảnh lắm nhưng vẫn ổn.', 9, 17, 55),
    (4, 'Dễ dàng vệ sinh, sử dụng tiện lợi.', 9, 18, 14),
    (5, 'Sản phẩm chất lượng cao, giá cả phải chăng.', 9, 9, 39),
    (5, 'Gỗ chắc chắn, màu vân gỗ sang trọng.', 9, 20, 39),
    (5, 'Rất hài lòng về chất lượng và mẫu mã.', 9, 23, 69),
    (5, 'Hơi khó lắp ráp một chút nhưng dùng rất thích.', 9, 11, 23),
    (3, 'Hài lòng với dịch vụ của shop.', 9, 22, 51),
    (4, 'Đóng gói rất kỹ, không trầy xước.', 9, 8, 4),
    (5, 'Đóng gói rất kỹ, không trầy xước.', 9, 14, 6),
    (4, 'Vượt xa mong đợi của mình, đóng gói cẩn thận.', 9, 7, 57),
    (5, 'Dùng một thời gian thấy rất bền.', 10, 7, 25),
    (5, 'Sản phẩm chất lượng cao, giá cả phải chăng.', 10, 19, 32),
    (3, 'Gỗ chắc chắn, màu vân gỗ sang trọng.', 10, 21, 6),
    (5, 'Nhân viên giao nhận nhiệt tình, chu đáo.', 10, 4, 56),
    (4, 'Giao hàng hơi chậm nhưng sản phẩm bù lại rất tốt.', 10, 11, 6),
    (5, 'Nhân viên giao nhận nhiệt tình, chu đáo.', 10, 14, 12),
    (5, 'Sản phẩm chất lượng cao, giá cả phải chăng.', 10, 23, 17),
    (3, 'Hơi khó lắp ráp một chút nhưng dùng rất thích.', 10, 8, 51),
    (3, 'Sản phẩm chất lượng cao, giá cả phải chăng.', 10, 16, 34),
    (4, 'Hài lòng với dịch vụ của shop.', 10, 6, 25);